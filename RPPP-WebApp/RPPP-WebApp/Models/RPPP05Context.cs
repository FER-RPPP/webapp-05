...
public partial class RPPP05Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDokument).HasName("PK__Dokument__420542B52EAF90A1");
        ...
        {
            entity.HasKey(e => new { e.Oib, e.IdUloga }).HasName("PK__Ima__53D3E463D4BDAF44");

            entity.Property(e => e.Oib).HasColumnName("OIB");
            entity.Property(e => e.IdUloga).HasColumnName("idUloga");

            entity.HasOne(d => d.IdUlogaNavigation).WithMany(p => p.Ima)
        ...
        {
            entity.HasKey(e => e.IdKvalifikacija).HasName("PK__kvalifik__18FC9B98B5D0F7A1");
        ...
        {
            entity.HasKey(e => e.IdPartner).HasName("PK__Partner__4D67B84FDB563146");

            entity.HasIndex(e => e.EmailPartner, "UQ__Partner__3F193BFD7FBE925E").IsUnique();

            entity.HasIndex(e => e.Ibanpartner, "UQ__Partner__695C0D148BE013DB").IsUnique();

            entity.HasIndex(e => e.Oib, "UQ__Partner__CB394B3E6582DAB1").IsUnique();
            ...
            entity.HasOne(d => d.IdTipPartneraNavigation).WithMany(p => p.Partner)
        ...
        {
            entity.HasKey(e => e.IdPosao).HasName("PK__Posao__C7661B95CA43F656");

            entity.Property(e => e.Opis)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.PredVrTrajanjaDani)
                .HasMaxLength(10)
                .IsUnicode(false);
            ...
            entity.HasOne(d => d.IdVrstaPosaoNavigation).WithMany(p => p.Posao)
        ...
        {
            entity.HasKey(e => e.IdProjekt).HasName("PK__Projekt__8FCCB4566ED920F8");
            ...
            entity.HasOne(d => d.IdTipNavigation).WithMany(p => p.Projekt)
                .HasForeignKey(d => d.IdTip)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Projekt__idTip__44952D46");

            entity.HasMany(d => d.IdPartner).WithMany(p => p.IdProjekt)
                .UsingEntity<Dictionary<string, object>>(
                    "Narucio",
                    r => r.HasOne<Partner>().WithMany()
                        .HasForeignKey("IdPartner")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__Narucio__idPartn__5C6CB6D7"),
                    l => l.HasOne<Projekt>().WithMany()
                        .HasForeignKey("IdProjekt")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__Narucio__idProje__5B78929E"),
                    j =>
                    {
        ...
        {
            entity.HasKey(e => e.SubjektIban).HasName("PK__Projektn__871E209838A1B9E4");
            ...
            entity.HasOne(d => d.IdProjektNavigation).WithMany(p => p.ProjektnaKartica)
                .HasForeignKey(d => d.IdProjekt)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Projektna__idPro__50FB042B");
        });

        modelBuilder.Entity<Radi>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.HasOne(d => d.IdPosaoNavigation).WithMany()
                .HasForeignKey(d => d.IdPosao)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Radi_Posao");

            entity.HasOne(d => d.OibNavigation).WithMany()
                .HasForeignKey(d => d.Oib)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Radi_Suradnik");
        });

        modelBuilder.Entity<StatusZadatka>(entity =>
        {
            entity.HasKey(e => e.IdStatus).HasName("PK__StatusZa__01936F74A8CD31F4");
        ...
        modelBuilder.Entity<Suradnik>(entity =>
        {
            ...
            entity.HasIndex(e => e.Mail, "UQ__Suradnik__7A212904543F6C26").IsUnique();

            entity.HasIndex(e => e.Mobitel, "UQ__Suradnik__7E79A46778DC6E9B").IsUnique();

            entity.HasIndex(e => e.IdSuradnik, "UQ__Suradnik__B9075C9BDCFCBD79").IsUnique();
            ...
            entity.HasOne(d => d.IdKvalifikacijaNavigation).WithMany(p => p.Suradnik)
                .HasForeignKey(d => d.IdKvalifikacija)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Suradnik__idKval__65F62111");

            entity.HasOne(d => d.IdPartnerNavigation).WithMany(p => p.Suradnik)
        ...
        {
            entity.HasKey(e => e.IdTipPartnera).HasName("PK__TipPartn__01BFB86166F4FE38");
        ...
        {
            entity.HasKey(e => e.IdTip).HasName("PK__TipProje__020FACBFD230405F");
        ...
        {
            entity.HasKey(e => e.PrimateljIban).HasName("PK__Transakc__64FB3C8E2F4EEF36");
            ...
            entity.HasOne(d => d.IdTransakcijeNavigation).WithMany(p => p.Transakcija)
                .HasForeignKey(d => d.IdTransakcije)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Transakci__idTra__6ABAD62E");

            entity.HasOne(d => d.SubjektIbanNavigation).WithMany(p => p.Transakcija)
        ...
        {
            entity.HasKey(e => e.IdUloga).HasName("PK__uloga__8EAAF5C8ED59755D");
            ...
            entity.HasOne(d => d.IdProjektNavigation).WithMany(p => p.Uloga)
                .HasForeignKey(d => d.IdProjekt)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.IdVrstaDok).HasName("PK__VrstaDok__D328B413502FC7CC");
        ...
        {
            entity.HasKey(e => e.IdVrstaPosao).HasName("PK__VrstaPos__BFA760BCC0389F06");
        ...
        {
            entity.HasKey(e => e.IdTransakcije).HasName("PK__VrstaTra__33A5BCE2EA084E63");
        ...
        {
            entity.HasKey(e => e.IdVrsta).HasName("PK__VrstaZah__306017AD96E18C88");
        ...
        {
            entity.HasKey(e => e.IdZadatak).HasName("PK__Zadatak__2FCCCF8E17604AA5");

            entity.HasIndex(e => e.IdZadatak, "UQ__Zadatak__05C20C63C613B77D").IsUnique();
            ...
            entity.HasOne(d => d.IdStatusNavigation).WithMany(p => p.Zadatak)
                .HasForeignKey(d => d.IdStatus)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Zadatak__idStatu__55BFB948");

            entity.HasOne(d => d.IdZahtjevNavigation).WithMany(p => p.Zadatak)
        ...
        {
            entity.HasKey(e => e.IdZahtjev).HasName("PK__Zahtjev__DD398F69DAB9BA74");
            ...
            entity.HasOne(d => d.IdProjektNavigation).WithMany(p => p.Zahtjev)
                .HasForeignKey(d => d.IdProjekt)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Zahtjev__idProje__4865BE2A");

            entity.HasOne(d => d.IdVrstaNavigation).WithMany(p => p.Zahtjev)
